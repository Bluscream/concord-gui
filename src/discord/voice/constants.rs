...
pub(super) const UDP_PING_PACKET_LEN: usize = 8;
pub(super) const UDP_PING_INTERVAL: Duration = Duration::from_secs(5);
...
pub(super) const VOICE_OP_SESSION_UPDATE: u8 = 14;
