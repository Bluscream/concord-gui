...
pub use rest::{
    ...
    ConnectionVisibility, DefaultNotifications, DiscoverableGuild, DmScanLevel, EventLocation,
    EventStatus, ExplicitContentFilter, ForumPostPage, FriendDiscovery, FriendSources,
    GuildBanInfo, GuildEdit, GuildEmojiInfo, GuildInviteInfo, GuildTemplate, GuildWidget,
