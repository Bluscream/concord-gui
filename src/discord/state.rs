...
impl DiscordState {
    ...
    pub fn apply_event(&mut self, event: &AppEvent) {
        match event {
            ...
            | AppEvent::DiscoverableGuildsLoaded { .. }
            | AppEvent::DiscoveryMetadataLoaded { .. }
            | AppEvent::GuildStickersLoaded { .. }
            ...
            | AppEvent::AuthorisedAppsLoadFailed { .. }
            | AppEvent::ConnectionsLoaded { .. }
            | AppEvent::ConnectionsLoadFailed { .. }
            | AppEvent::AutoModRulesLoaded { .. }
            | AppEvent::AutoModRulesLoadFailed { .. }
