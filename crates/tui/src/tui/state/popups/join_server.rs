...
use concord::discord::{AppCommand, InvitePreview, invite_code_from};
...
pub(in crate::tui) struct JoinServerState {
    ...
    discovered: Vec<concord::discord::DiscoverableGuild>,
    discovering: bool,
...
impl JoinServerState {
    ...
    pub(in crate::tui) fn discovered(&self) -> &[concord::discord::DiscoverableGuild] {
        &self.discovered
    }
...
impl DashboardState {
    ...
    pub(in crate::tui) fn set_discovered_guilds(
        &mut self,
        guilds: Vec<concord::discord::DiscoverableGuild>,
    ) {
