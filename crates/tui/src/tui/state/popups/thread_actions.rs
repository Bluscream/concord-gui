...
use concord::discord::{AppCommand, DiscordAction, MuteDuration};
        ...
        self.discord
            ...
            .is_some_and(|channel| {
                let permission = if channel.thread_archived().unwrap_or(false) {
                    concord::discord::DiscordPermission::ReopenThread
                } else {
                    concord::discord::DiscordPermission::EditOwnThread
                };
                self.discord
                    .cache
