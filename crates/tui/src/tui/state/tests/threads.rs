...
fn channel_tree_shows_only_joined_active_forum_posts_and_text_threads() {
    ...
    state.push_event(concord::discord::test_builders::guild_create_event(
        GuildCreateFixture {
            channels: vec![
...
fn post_data_hydrates_active_cards_without_changing_joined_sidebar_state() {
    ...
    assert_eq!(
        ...
        Some(concord::discord::ForumPostDataRequestTarget {
            guild_id,
            channel_id: forum_id,
...
fn forum_body_appends_archived_posts_without_adding_sidebar_rows() {
    ...
    assert_eq!(
        ...
        Some(concord::discord::ArchivedThreadRequestTarget {
            guild_id,
            channel_id: forum_id,
        ...
        update: ThreadMemberListUpdateInfo {
            ...
            members: vec![
                ThreadMemberInfo {
                    ...
                    presence: Some(concord::discord::PresenceEventFields {
                        user_id: alice_id,
