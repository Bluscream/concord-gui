use super::*;
use concord_fixtures::events::guild_create_event;
...
fn message_history_authors_missing_member_roles_are_requested_from_batch() {
    ...
    duplicate.mentions = vec![concord::discord::MentionInfo::test(
        Id::new(98),
        "mentioned",
    )];
    duplicate.reply = Some(ReplyInfo {
        author_id: Some(Id::new(97)),
        mentions: vec![concord::discord::MentionInfo::test(
            Id::new(96),
            "reply mention",
        )],
        ..ReplyInfo::test("reply author")
    });
    duplicate.interaction = Some(concord::discord::MessageInteractionInfo {
        user_id: Some(Id::new(94)),
        ..concord::discord::MessageInteractionInfo::test("interaction user")
    });
    ...
    webhook.mentions = vec![concord::discord::MentionInfo::test(
        Id::new(92),
        "webhook mention",
    )];
