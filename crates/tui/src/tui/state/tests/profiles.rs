...
use concord::discord::{
    ...
    RichPresenceSelection, UserProfileUpdate,
};
...
fn profile_settings_activity_field_shows_non_playing_relayed_activity() {
    ...
    state.push_event(AppEvent::PresenceUpdate {
        ...
        presence: concord::discord::PresenceEventFields {
            ...
            status: PresenceStatus::Online,
            activities: vec![
                ActivityInfo::test(concord::discord::ActivityKind::Custom, "deep in thought"),
                ActivityInfo::test(concord::discord::ActivityKind::Listening, "Spotify"),
            ],
        },
    });
    state.open_current_user_profile_popup();
    ...
    state.push_event(AppEvent::PresenceUpdate {
        ...
        presence: concord::discord::PresenceEventFields {
            ...
            activities: vec![ActivityInfo::test(
                concord::discord::ActivityKind::Custom,
                "deep in thought",
            )],
        },
    });
