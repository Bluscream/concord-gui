...
impl Workspace {
    ...
    pub(super) fn overlays(&self, cx: &mut Context<Self>) -> Option<gpui::AnyElement> {
        ...
        if let Some(pending) = &self.confirming {
            ...
            return Some(
                (overlay::scrim().child(overlay::confirm_view(
                    prompt,
                    {
                        let entity = entity.clone();
                        move |cx: &mut gpui::App| {
        ...
        if let Some((action, dont_ask)) = &self.risk {
            ...
            return Some(
                (overlay::scrim().child(overlay::risk_warning_view(
                    overlay::RiskWarning {
            ...
            && let Some(image) = self.attachment_previews.get(url)
        {
            ...
            return Some(
                (
                    // Not wrapped in a plain div any more. The wrapper was
                    // there only to satisfy the old return type, and it gave
                    // the scrim a zero-sized parent to be absolute inside -
                    // so the viewer sat at the bottom of the window with
        ...
        if let Some(view) = &self.permission_grid {
            ...
            return Some(
                (overlay::scrim().child(overlay::permission_grid_view(
                    &view.name,
                    &rows,
                    view.is_dirty(),
                    {
        ...
        if let Some(view) = &self.account {
            ...
            return Some(
                (overlay::scrim().child(overlay::account_view(
        ...
        if let Some(view) = &self.access {
            ...
            return Some(
                (overlay::scrim().child(overlay::access_view(
                    overlay::AccessPanel {
                        rows: &rows,
        ...
        if self.privacy_open {
            ...
            return Some(
                (overlay::scrim().child(overlay::privacy_view(
                    &rows,
                    {
                        let entity = entity.clone();
                        move |index, cx: &mut gpui::App| {
        ...
        if let Some(view) = &self.connections {
            ...
            return Some(
                (overlay::scrim().child(overlay::connections_view(
                    &rows,
                    view.loading,
                    view.error.as_deref(),
                    {
        ...
        if let Some(view) = &self.soundboard {
            ...
            return Some(
                (overlay::scrim().child(overlay::soundboard_view(
                    &rows,
                    view.loading,
                    view.error.as_deref(),
                    {
        ...
        if let Some(view) = &self.server_management {
            ...
            return Some(
                (overlay::scrim().child(overlay::server_management_view(
                    overlay::ServerPanel {
                        tabs: &tabs,
                        rows: &rows,
                        ...
                        move |index, cx: &mut gpui::App| {
                            entity.update(cx, |workspace, cx| {
                                match tab {
                                    ...
                                    ServerTab::Membership => {
                                        workspace.activate_membership_row(index)
                                    }
                                    ...
                                    ServerTab::Onboarding => {
                                        workspace.pick_onboarding_answer(index)
                                    }
                            ...
                            move |cx: &mut gpui::App| {
                                entity.update(cx, |workspace, cx| {
                                    workspace.prompt = Some(match tab {
                                        ...
                                        ServerTab::Events => {
                                            (Prompt::NewEvent, Composer::default())
                                        }
                                        ServerTab::Stickers => {
                                            (Prompt::NewSticker, Composer::default())
                                        }
                                        ServerTab::Settings => {
                                            (Prompt::GuildIcon, Composer::default())
                                        }
        ...
        if let Some(view) = &self.bans {
            ...
            return Some(
                (overlay::scrim().child(overlay::ban_list_view(
                    &rows,
                    status.as_deref(),
                    {
                        let entity = entity.clone();
        ...
        if self.editing_roles.is_some() {
            ...
            return Some(
                (overlay::scrim().child(overlay::role_picker_view(
                    &roles,
                    {
                        let entity = entity.clone();
                        move |index, cx: &mut gpui::App| {
        ...
        if self.sticker_picker {
            ...
            return Some(
                (overlay::scrim().child(overlay::sticker_picker_view(
                    &choices,
                    {
                        let entity = entity.clone();
                        move |index, cx: &mut gpui::App| {
        ...
        if let Some(invite) = &self.invite {
            ...
            return Some(
                (overlay::scrim().child(overlay::invite_view(
                    &row,
                    {
                        let entity = entity.clone();
                        move |cx: &mut gpui::App| {
        ...
        if let Some((prompt, text)) = &self.prompt {
            ...
            return Some(
                (overlay::scrim().child(overlay::text_prompt_view(
                    title,
                    placeholder,
                    text.text(),
                    discovery,
        ...
        if let Some(draft) = &self.editing_activity {
            ...
            return Some(
                (overlay::scrim().child(overlay::activity_editor_view(
                    &kinds,
                    &fields,
                    {
                        let entity = entity.clone();
        ...
        if let Some(picker) = &self.picker {
            ...
            return Some(
                (overlay::scrim().child(emoji::picker_view(cursor, {
                    let entity = entity.clone();
        ...
        if let Some(picker) = &self.stream_picker {
            return Some(
                (overlay::scrim().child(stream::picker_view(
                    picker,
                    {
                        let entity = entity.clone();
                        move |index, cx: &mut gpui::App| {
        ...
        if let Some(devices) = &self.audio_devices {
            return Some(
                (overlay::scrim().child(overlay::audio_devices_view(
                    &devices.inputs,
                    &devices.outputs,
        ...
        if let Some(mentions) = &self.inbox {
            ...
            return Some(
                (overlay::scrim().child(overlay::inbox_view(
                    &rows,
                    {
                        let entity = entity.clone();
                        move |index, cx: &mut gpui::App| {
