...
pub fn clamp_cursor_index(value: &str, index: usize) -> usize {
...
pub fn previous_word_boundary(input: &str, index: usize) -> usize {
...
pub fn next_word_boundary(input: &str, index: usize) -> usize {
    let index = clamp_cursor_index(input, index);
...
pub fn vertical_cursor_target(input: &str, cursor: usize, direction: isize) -> Option<usize> {
