...
impl KeyBindings {
    pub fn binding_summaries(&self) -> Vec<KeymapBindingSummary> {
    ...
    pub fn binding_label(&self, action: UiAction) -> String {
        self.keymap.first_sequence_label(action)
    }

    pub fn leader_keymap_prefix(&self) -> Vec<KeyChord> {
        vec![self.keymap.leader]
    }

    pub fn is_leader_key(&self, key: impl Into<KeyEvent>) -> bool {
        let key: KeyEvent = key.into();
        self.keymap.leader.matches(key)
    }

    #[cfg(test)]
    pub fn keymap_lookup_direct_key(&self, key: impl Into<KeyEvent>) -> Option<UiAction> {
        let key: KeyEvent = key.into();
    ...
    pub fn keymap_lookup_root_key(&self, key: impl Into<KeyEvent>) -> Option<KeyMapLookup> {
        let key: KeyEvent = key.into();
        let sequence = [self.keymap_chord_for_event(key)];
        self.keymap.lookup(&sequence)
    }

    pub fn keymap_lookup_with_key(
        &self,
        prefix: &[KeyChord],
    ...
    pub fn popup_keymap_lookup_with_key(
        &self,
        prefix: &[KeyChord],
        key: impl Into<KeyEvent>,
    ...
    pub fn keymap_chord_for_event(&self, key: impl Into<KeyEvent>) -> KeyChord {
        let key: KeyEvent = key.into();
        KeyChord {
            code: key.code,
            modifiers: key.modifiers,
    ...
    pub fn keymap_prefix_title(&self, prefix: &[KeyChord]) -> String {
    ...
    pub fn leader_keymap_children(&self, prefix: &[KeyChord]) -> Vec<LeaderShortcutItem> {
        self.keymap.children(prefix)
    }

    pub fn popup_keymap_children(
        &self,
        prefix: &[KeyChord],
        scope: PopupKeymapScope,
    ...
    pub fn dashboard_action_for_ui_action(
        &self,
        action: UiAction,
        focus: FocusPane,
    ...
    pub fn dashboard_action(&self, key: impl Into<KeyEvent>) -> Option<DashboardAction> {
        let key: KeyEvent = key.into();
    ...
    pub fn channel_switcher_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn notification_inbox_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn notification_inbox_mark_read_label(&self) -> String {
        key_chord_list_label(
            &self.notification_inbox_action_shortcuts(NotificationInboxActionKind::MarkRead),
        )
    }

    pub fn notification_inbox_mark_all_read_label(&self) -> String {
        key_chord_list_label(
            &self.notification_inbox_action_shortcuts(NotificationInboxActionKind::MarkAllRead),
        )
    }

    pub fn notification_inbox_activate_label(&self) -> String {
        key_chord_list_label(&self.notification_inbox_activate_shortcuts())
    }

    pub fn notification_inbox_tab_switch_label(&self, tab: NotificationInboxTab) -> String {
    ...
    pub fn search_popup_action(&self, key: impl Into<KeyEvent>) -> Option<SearchPopupAction> {
        let key: KeyEvent = key.into();
        if let Some(action) = self.selection_action(key, SelectionKeySet::TextSafe) {
    ...
    pub fn popup_list_action(&self, key: impl Into<KeyEvent>) -> Option<PopupListAction> {
        let key: KeyEvent = key.into();
        if let Some(action) = self.selection_action(key, SelectionKeySet::Navigation) {
    ...
    pub fn attachment_viewer_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn pane_filter_action(&self, key: impl Into<KeyEvent>) -> Option<PaneFilterAction> {
        let key: KeyEvent = key.into();
        if let Some(action) = self.selection_action(key, SelectionKeySet::TextSafe) {
    ...
    pub fn emoji_reaction_picker_action(
        &self,
        key: impl Into<KeyEvent>,
        filter_editing: bool,
    ...
    pub fn poll_vote_picker_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn reaction_users_popup_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn voice_participant_audio_popup_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn composer_action(&self, key: impl Into<KeyEvent>) -> ComposerAction {
        let key: KeyEvent = key.into();
    ...
    pub fn composer_completion_action(&self, key: impl Into<KeyEvent>) -> ComposerCompletionAction {
        let key: KeyEvent = key.into();
        if let Some(action) = self.selection_action(key, SelectionKeySet::TextSafe) {
    ...
    pub fn login_global_action(&self, key: impl Into<KeyEvent>) -> Option<LoginGlobalAction> {
        let key: KeyEvent = key.into();
        match key.code {
            KeyCode::Char('c') if key.modifiers.contains(KeyModifiers::CONTROL) => {
    ...
    pub fn login_mode_select_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn login_text_input_action(&self, key: impl Into<KeyEvent>) -> LoginTextInputAction {
        let key: KeyEvent = key.into();
        match key.code {
    ...
    pub fn login_password_input_action(
        &self,
        key: impl Into<KeyEvent>,
    ...
    pub fn login_mfa_select_action(&self, key: impl Into<KeyEvent>) -> LoginMfaSelectAction {
        let key: KeyEvent = key.into();
        match key.code {
            KeyCode::Char(value) if value.eq_ignore_ascii_case(&'t') => {
    ...
    pub fn login_busy_action(&self, key: impl Into<KeyEvent>) -> LoginBusyAction {
        let key: KeyEvent = key.into();
        match key.code {
    ...
    pub fn is_popup_close_key(&self, key: impl Into<KeyEvent>) -> bool {
        let key: KeyEvent = key.into();
    ...
    pub fn is_text_entry_popup_close_key(&self, key: impl Into<KeyEvent>) -> bool {
        let key: KeyEvent = key.into();
        self.is_popup_close_key(key) && !is_text_entry_character(key)
    }

    pub fn physical_popup_page_action(&self, key: impl Into<KeyEvent>) -> Option<SelectionAction> {
        let key: KeyEvent = key.into();
        match key.code {
    ...
    pub fn text_safe_popup_page_action(&self, key: impl Into<KeyEvent>) -> Option<SelectionAction> {
        let key: KeyEvent = key.into();
    ...
    pub fn horizontal_adjustment_delta(&self, key: impl Into<KeyEvent>) -> Option<i8> {
        let key: KeyEvent = key.into();
        match key.code {
    ...
    pub fn horizontal_selection_action(&self, key: impl Into<KeyEvent>) -> Option<SelectionAction> {
        let key: KeyEvent = key.into();
    ...
    fn default_channel_action_shortcut(&self, kind: ChannelActionKind) -> Vec<KeyChord> {
        match kind {
            ...
            ChannelActionKind::RequestToSpeak => vec![char_chord('h')],
            ChannelActionKind::ToggleStage => vec![char_chord('S')],
            ChannelActionKind::InviteToSpeak => vec![char_chord('I')],
    ...
    pub fn matching_action_shortcut_index<A>(
        &self,
        actions: &[A],
        shortcut: KeyChord,
    ...
    pub fn indexed_shortcut_matches(&self, shortcut: KeyChord, index: usize) -> bool {
        Self::indexed_shortcut(index).is_some_and(|candidate| shortcut.matches_char(candidate))
    }

    pub fn matching_indexed_shortcut_index(&self, shortcut: KeyChord, len: usize) -> Option<usize> {
