...
use crate::key::{KeyCode, KeyEvent, KeyModifiers, MediaKeyCode};
...
impl KeyChord {
    pub fn matches_chord(self, other: Self) -> bool {
        key_chords_match_same_event(self, other)
    }

    pub fn matches_char(self, value: char) -> bool {
...
pub fn push_to_talk_shortcut_from_key(
